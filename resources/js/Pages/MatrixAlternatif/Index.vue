...
<template>
    <AuthenticatedLayout>
        ...
        <template #header>
            ...
            <p class="text-gray-100 text-sm">Halaman ini berfungsi untuk membandingkan hasil dari setiap bobot alternatif yang digunakan untuk menampilkan alternatif/interior terbaik.</p>
        </template>
