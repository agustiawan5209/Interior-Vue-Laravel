...
<template>
    <AuthenticatedLayout>
        ...
        <template #header>
            ...
            <p class="text-gray-100">Kriteria ini merupakan aspek visual dan keindahan dari interior yang dipilih. Misalnya, desain, warna, gaya, dan tata letak yang menarik. </p>
        </template>
