...
<template>
    <AuthenticatedLayout>
        ...
        <template #header>
            ...
            <p class="text-gray-100 text-sm">Edit Form alternatif digunakan untuk Mengedit data interior yang ada pada perusahaan atau manufactur. pada form ini diharuskan untuk mengisi setiap inputan yang ada dan memilih subkriteria dari setiap kriteria interior seperti model,ruangan, dll.</p>
        </template>
